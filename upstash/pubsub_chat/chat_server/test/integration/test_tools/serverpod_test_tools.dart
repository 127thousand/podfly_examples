...
import 'package:chat_server/src/generated/chat/chat_message.dart' as _i5;
import 'package:chat_server/src/generated/greetings/greeting.dart' as _i6;
...
class _ChatEndpoint {
  ...
  _i4.Stream<_i5.ChatMessage> listen(_i1.TestSessionBuilder sessionBuilder) {
  ...
  _i4.Future<String> whoami(_i1.TestSessionBuilder sessionBuilder) async {
  ...
  _i4.Future<_i5.ChatMessage> send(
