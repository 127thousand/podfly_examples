...
import 'package:notes_server/src/generated/greetings/greeting.dart' as _i5;
import 'package:notes_server/src/generated/notes/note.dart' as _i6;
...
class _NoteEndpoint {
  ...
  _i4.Future<List<_i6.Note>> list(_i1.TestSessionBuilder sessionBuilder) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'note',
  ...
  _i4.Future<int> count(_i1.TestSessionBuilder sessionBuilder) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'note',
