...
import '../notes/note_endpoint.dart' as _i3;
        ...
        'add': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['note'] as _i3.NoteEndpoint).add(
                session,
                params['text'],
              ),
        ),
        'list': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['note'] as _i3.NoteEndpoint).list(session),
        ),
        'count': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['note'] as _i3.NoteEndpoint).count(session),
        ),
      },
    );
  }
