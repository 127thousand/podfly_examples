...
import 'package:notes_client/src/protocol/greetings/greeting.dart' as _i3;
import 'package:notes_client/src/protocol/notes/note.dart' as _i4;
...
class EndpointNote extends _i1.EndpointRef {
  ...
  _i2.Future<_i4.Note> add(String text) => caller.callServerEndpoint<_i4.Note>(
    'note',
    'add',
    {'text': text},
  );
