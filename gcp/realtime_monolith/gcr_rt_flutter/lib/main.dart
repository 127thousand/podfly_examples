...
import 'package:gcr_rt_client/gcr_rt_client.dart';
...
///
/// On Flutter web in the Cloud Run monolith image, the UI and API share one
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Serverpod realtime on Cloud Run',
      theme: ThemeData(
...
class _HomePageState extends State<HomePage> {
  final _nameController = TextEditingController(text: 'Cloud Run');
  String? _hello;
  String? _helloError;
  final _ticks = <String>[];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Serverpod · Cloud Run monolith'),
      ...
      body: ListView(
        ...
        children: [
          Text(
            'One Cloud Run service: nginx serves Flutter web and proxies '
